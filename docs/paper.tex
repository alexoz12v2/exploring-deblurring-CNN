...
prestazioni comparabili e dei risultati sensibili  
La nostra scelta è ricaduta in definitiva  n na variante intermedia tra la \textit{S} e la \textit{B}, con \(\mathbf{n=6}\) blocchi residuali.
...
\begin{figure}[ht]
  ...
  \caption{Metriche: SSIM (a sinistra) e PSNR (a destra) su epochs.}
